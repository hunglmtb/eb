<?php
	$currentSubmenu ='/pd/voyageground';
	$tables = ['PdTransportGroundDetail'	=>['name'=>'Load']];
	$isLoad = 0;
?>
...
@parent
<script>
	actions.loadUrl = "/voyageground/load";
	actions.saveUrl = "/voyageground/save";
