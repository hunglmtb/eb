...
var mxEffects = {
    ...
    popup_cus: function(title,innerHtml,width,height)
    {
        ...
        c.appendChild(d);
        c = new mxWindow(title, c, document.body.clientWidth / 2 - width/2, (document.body.clientHeight || document.documentElement.clientHeight) / 2 - height/2, width, height, false, true);
        c.setClosable(true);
        c.setVisible(true);
    }
    ,
    ...
    NONE: "none",
    SWIMLANE_HIGHLIGHTCOLOR: "#D1E3EF",
...
mxShape.prototype.apply = function (a) {
    ...
    if (a != null) {
        this.isHighlight = mxUtils.getValue(a, mxConstants.STYLE_HIGHLIGHT, this.isHighlight);
...
mxSwimlane.prototype.createSvg = function () {
    ...
    this.content.setAttribute("fill", this.isHighlight ? mxConstants.SWIMLANE_HIGHLIGHTCOLOR : "none");
    if (this.isRounded) {
    ...
    if (b != null) {
        ...
        this.separator.setAttribute("stroke-dasharray", "12, 2");
        a.appendChild(this.separator)
    }
    if (this.image != null) {
        this.imageNode = document.createElementNS(mxConstants.NS_SVG, "image");
...
mxSwimlane.prototype.redrawSvg = function () {
    ...
    //alert(this.content.getAttribute("d"));
    if (this.imageNode != null) {
    ...
    //alert();
    this.content.setAttribute("stroke-dasharray", "5, 3");
    this.content.setAttribute("fill", this.isHighlight ? mxConstants.SWIMLANE_HIGHLIGHTCOLOR : "none");
...
mxCellEditor.prototype.div = null;
...
mxCellEditor.prototype.init = function () {
    this.div = document.createElement("div");
    $('<span/>').text("adfasdf").appendTo(this.div);
    this.div.innerHTML = "<span>asdfsadfsdf</span>"
    this.div.className = "mxCellEditor";
    this.div.style.position = "absolute";
    this.div.style.overflow = "visible";
    if (mxClient.IS_GC) this.div.style.resize = "none";
    mxEvent.addListener(this.div, "blur", mxUtils.bind(this, function () {
        this.focusLost()
    }));
...
mxOutline.prototype.init = function (a) {
    ...
    this.outline.graphModelChanged = mxUtils.bind(this, function (a) { ! this.suspended && this.outline != null && b.apply(this.outline, arguments)
    });
    if (mxClient.IS_SVG) {
    ...
    this.updateHandler = mxUtils.bind(this, function () { ! this.suspended && !this.active && this.update()
    });
...
mxEditor.prototype.dblClickAction = "showProperties";
