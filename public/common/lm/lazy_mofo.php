...
//echo "a:".$_GET[$this->identity_name];
    ...
    function grid($error = ''){
        ...
        $html .= "<table id='lm_grid' cellpadding='2' cellspacing='1' border='0' width='100%' class='lm_grid'>\n";
        $html .= $head;
    ...
    function get_input_control($column_name, $value, $command, $called_from){
        ...
        if($cmd == 'text')
            return "<input style='width:100%' type='text' name='$column_name' class='$class' value='" . $this->clean_out($value) . "' size='$size' />";
        elseif($cmd == 'hidden')
